...
export const TreeIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 12.75 18 15m0 0-2.25 2.25M18 15l2.25 2.25m-15-7.5L4.5 9m0 0 2.25-2.25M4.5 9l2.25 2.25m1.5-3-2.25-2.25m0 0L9 3m2.25 2.25L9 3m0 0L6.75 5.25M12 12.75V21m0 0h-3m3 0h3m-3-8.25-3-3m3 3 3-3m-3-3-3-3m3 3 3 3" />
    </svg>
);
